...
begin
    ...
    where run.dataset_code = 'call_auction_market_snapshot'
      ...
      and (snapshot.observed_at at time zone 'Asia/Shanghai')::time >= time '09:25:30'
    ...
    if selected_date is null then
        raise exception '09:25:30 auction snapshot not found' using errcode = 'P0002';
    end if;
