...
2026-09-06 补充：从 2026-09-07 交易日起，ADR-0034 将 `sample_seq=30` 调整为
`09:24:53`，其 deadline 为下一轮 `09:25:20`。本 ADR 的 Producer/单 Writer 解耦原则不变；
“20 秒 cadence”指其余基础时槽，不再表示最后四轮全部等距。
