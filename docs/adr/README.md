...
- `ADR-0028-暂停全市场竞价Raw重放与移除自动最终化.md`：保留 09:25:50 五档来源采集和 Raw，暂停缺少原冻结全集身份的 replay，并移除 21:30 自动最终化及旧 JobStore 残留；不增加替代计划。
...
- `ADR-0039-09点26沪深主板一字涨跌停实时计算.md`：取代 ADR-0032 的晚间 CalculationRun 依赖，基于已存 09:25:50 快照只读实时计算沪深主板一字涨跌停。
