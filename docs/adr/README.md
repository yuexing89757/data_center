...
- `ADR-0058-无损Raw压缩与受控存储清理.md`（Proposed）：已批准范围的详设待复核；拟扩展03:00任务，加入Raw无损压缩、白名单质量归档、容量保护和独立发布物清理，尚未实施。
- `ADR-0055-Tushare龙虎榜历史与游资席位画像.md`：以 Tushare 独立补全最近两年完全缺失的龙虎榜交易日，维护人工审核且带有效期的游资—席位目录，并物化时点安全的 T+1/T+3/T+5 席位画像；只暴露客观资金质量组成，不生成主观总分。
